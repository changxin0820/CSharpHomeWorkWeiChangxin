...
namespace OrderForm {
  public partial class FormEdit : Form {
    ...
    public FormEdit() {
      ...
      customerBindingSource.Add(new Customer("1", "WCX"));

      customerBindingSource.Add(new Customer("2", "WCX2"));

      customerBindingSource.Add(new Customer("3", "WCX3"));
    ...
    private void btnAddItem_Click(object sender, EventArgs e) {//添加订单
