...
namespace OrderForm {
  public partial class FormMain : Form {
    ...
    public FormMain() {
      ...
      Order order = new Order(1, new Customer("1", "WCX1"), new List<OrderItem>());
      order.AddItem(new OrderItem(1, new Goods("1", "iphone", 100.0), 2));
      orderService.AddOrder(order);
      Order order2 = new Order(2, new Customer("2", "WCX2"), new List<OrderItem>());
      order2.AddItem(new OrderItem(1, new Goods("2", "TV", 200.0), 15));
    ...
    private void btnAdd_Click(object sender, EventArgs e) {//添加订单
